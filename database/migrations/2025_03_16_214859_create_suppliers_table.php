...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->enum('supplier_status', ['active', 'pending', 'inactive', 'blocked'])->default('pending');
            ...
            $table->enum('supplier_tier', ['unclassified', 'individual', 'basic', 'enterprise', 'premium', 'group'])->default('unclassified');
