...
watch(() => supplier.value.vat_exemption_certificate_id, newValue => {
  if (!newValue) {
    supplier.value.vat_exemption_certificate_issue_date = null
    supplier.value.vat_exemption_certificate_expiration_date = null
      ...
      <VCard>
        <VCardText>
          ...
          <VRow>
            ...
            >
              <VAutocomplete
                v-model="supplier.payment_terms"
            ...
            >
              <VTextField
                v-model="supplier.outstanding_balance"
            ...
            >
              <VAutocomplete
                v-model="supplier.preferred_currency"
          ...
          <VRow>
            <VCol cols="12">
              <VTextField
                v-model="supplier.vat_exemption_certificate_id"
            ...
            <VCol cols="12">
              <div v-if="!readOnly">
                ...
                >
                  <VExpansionPanel :disabled="!supplier.vat_exemption_certificate_id">
                    ...
                    <VExpansionPanelText>
                      <VRow>
                        ...
                        >
                          <AppDateTimePicker
                            v-model="supplier.vat_exemption_certificate_issue_date"
                            :label="$t('Issue Date')"
                            :config="{ inline: true }"
                          />
                        </VCol>
                        ...
                        >
                          <AppDateTimePicker
                            v-model="supplier.vat_exemption_certificate_expiration_date"
                ...
                <VRow>
                  ...
                  >
                    <div>
                      ...
                      {{ supplier.vat_exemption_certificate_issue_date }}
                    </div>
                  </VCol>
                  <VCol
                    cols="6"
                  ...
                  >
                    <div>
                      ...
                      {{ supplier.vat_exemption_certificate_expiration_date }}
                    </div>
                  </VCol>
                </VRow>
              </div>
